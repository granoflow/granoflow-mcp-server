...
| Unattended Card-Truth Batch Gate       | Interactive RB/UIT apply before UAT   | `unattended-card-truth-batch-gate` + `lint_unattended_card_truth_ready.py`                                                                                                                                                 | `card_truth_batch_gate_missing`, `card_truth_batch_gate_blocked`, `card_truth_delivery_claim_without_apply`                                                                                                                                                                         |
...
missing docs (`task_analysis_plan_attachment_required`); leave App `pending`
